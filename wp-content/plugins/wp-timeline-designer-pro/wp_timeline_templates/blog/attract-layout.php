 ...
 * This template can be overridden by copying it to yourtheme/wp_timeline_templates/blog/attract-layout.php.
 *
...
<div class="wtl-attract-post-content " data-aos="<?php echo esc_attr( $wtl_animation ); ?>">
	<?php Wtl_Template_Attract_Layout::get_post_image( $wtl_settings ); ?>
