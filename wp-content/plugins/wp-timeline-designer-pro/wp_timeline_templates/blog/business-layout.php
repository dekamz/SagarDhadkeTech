 ...
 * This template can be overridden by copying it to yourtheme/wp_timeline_templates/blog/business-layout.php.
 *
...
$class_name = 'two_column blog_template business blog_masonry_item ';
...
if ( 1 == $layout_type ) {
	...
	<div class="<?php echo esc_attr( $class_name ); ?> wtl_blog_single_post_wrapp <?php echo esc_attr( $category ); ?>">
		...
		<div class="wp_timeline_main_section">
			<div class="wp-timeline-item-divier-item left-side">
				<div class="wp-timeline-item-divier-dots left-side top-side">
					<div class="wp-timeline-dots-wave left-side"></div>
				</div>
				<div class="wp-timeline-item-divier-dots left-side bottom-side">
					<div class="wp-timeline-dots-wave left-side"></div>
				</div>
			</div>
			<div class="wp-timeline-item-divier-item right-side">
				<div class="wp-timeline-item-divier-dots right-side top-side">
					<div class="wp-timeline-dots-wave right-side"></div>
				</div>
				<div class="wp-timeline-item-divier-dots right-side bottom-side">
					<div class="wp-timeline-dots-wave right-side"></div>
				</div>
			</div>
			<div class="blog_item">
