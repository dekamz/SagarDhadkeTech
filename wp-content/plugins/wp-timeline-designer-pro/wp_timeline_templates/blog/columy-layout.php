 ...
 * This template can be overridden by copying it to yourtheme/wp_timeline_templates/blog/columy-layout.php.
 *
...
?>
	<div class="wtl-schedule-post-content <?php echo 'post_' . esc_attr( Wtl_Template_Columy_Layout::even_odd( $i ) ); ?>" data-aos="<?php echo esc_attr( $wtl_animation ); ?>">
		<?php Wtl_Template_Columy_Layout::get_post_image( $wtl_settings ); ?>
			<div class="wtl-post-content">
				<?php
					echo wp_kses( Wtl_Template_Columy_Layout::get_post_date( $wtl_settings, true ), Wp_Timeline_Public::args_kses() );
					echo wp_kses( Wtl_Template_Columy_Layout::get_tags( $wtl_settings, true, true ), Wp_Timeline_Public::args_kses() );
					Wtl_Template_Config::get_title( $wtl_settings );
					Wtl_Template_Columy_Layout::get_author( $wtl_settings );
