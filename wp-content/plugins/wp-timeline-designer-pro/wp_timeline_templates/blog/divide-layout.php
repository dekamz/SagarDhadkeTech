 ...
 * This template can be overridden by copying it to yourtheme/wp_timeline_templates/blog/divide-layout.php.
 *
...
$post_content_color_set = isset( $wtl_details['wtl_content_color'] ) ? ' style="color:' . $wtl_details['wtl_content_color'] . ';" ' : ''; ?>
	<div class="wtl-divide-post-content " data-aos="<?php echo esc_attr( $wtl_animation ); ?>">
