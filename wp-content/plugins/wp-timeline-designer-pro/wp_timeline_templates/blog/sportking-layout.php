 ...
 * This template can be overridden by copying it to yourtheme/wp_timeline_templates/blog/sportking-layout.php.
 *
...
?>
	<div class="wtl-schedule-post-content <?php echo 'post_' . esc_attr( Wtl_Template_Sportking_Layout::even_odd( $i ) ); ?>" data-aos="<?php echo esc_attr( $wtl_animation ); ?>">
		<?php echo wp_kses ( Wtl_Template_Sportking_Layout::get_post_image( $wtl_settings ), Wp_Timeline_Public::args_kses() ); ?>
		<div class="wtl-schedule-post-content-inner">
			<div class="wtl_title_cat">
				<?php
				Wtl_Template_Config::get_title( $wtl_settings );
				Wtl_Template_Sportking_Layout::get_category( $wtl_settings, true, true );
				?>
			</div>
			<div class="post_tag taxonomies">
				<div class="post-tag-inner">
					<?php echo wp_kses( Wtl_Template_Sportking_Layout::get_tags( $wtl_settings, true, true ), Wp_Timeline_Public::args_kses() ); ?>
				</div>
			</div>
			<div class="wtl-meta-content">
				<div class="wtl-meta-content-left">
					<?php
					Wtl_Template_Sportking_Layout::get_author( $wtl_settings );
			...
			<div class="wtl-post-content">
				<div class="post-content-inner">
					<?php
					Wtl_Template_Sportking_Layout::get_content( $wtl_settings );
