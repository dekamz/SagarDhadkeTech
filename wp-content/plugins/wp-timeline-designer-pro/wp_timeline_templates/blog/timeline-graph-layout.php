 ...
 * This template can be overridden by copying it to yourtheme/wp_timeline_templates/blog/timeline-graph-layout.php.
 *
...
$class_name = 'four_column blog_template timeline_graph blog_masonry_item ';
			...
			<div class="blog_item">
				<div class="post_summary_outer">
					...
					<?php
								...
								?>
							<div class="wp-timeline-details-section">
								<div class="blog_header">
									<?php
									Wtl_Template_Config::get_title( $wtl_settings );
									?>
