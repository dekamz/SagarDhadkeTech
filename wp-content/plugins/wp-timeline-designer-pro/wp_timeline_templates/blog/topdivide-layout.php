 ...
 * This template can be overridden by copying it to yourtheme/wp_timeline_templates/blog/dividetop-layout.php.
 *
...
$post_content_color_set = isset( $wtl_details['wtl_content_color'] ) ? ' style="color:' . $wtl_details['wtl_content_color'] . ';" ' : ''; ?>
	<div class="wtl-divide-post-content">
		...
		<div class="wtl-post-content">
			...
			<div class="wtl-main-social-cat-content">
				<div class="wtl-social-cat-content">
				<?php
				echo wp_kses( Wtl_Template_Config::get_category( $wtl_settings, true, true ), Wp_Timeline_Public::args_kses() );
				?>
				</div>
				<div class="wtl-social-social-content">
				<?php Wtl_Template_Config::get_social_media( $wtl_settings ); ?>
				</div>
			</div>
		</div>
	</div>
