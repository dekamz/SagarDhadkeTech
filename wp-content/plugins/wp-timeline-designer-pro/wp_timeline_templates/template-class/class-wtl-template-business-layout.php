 ...
 */
class Wtl_Template_Business_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		$out .= '<div id="wtl_business_layout" class="wtl_wrapper wp_timeline_post_list schedule_cover ' . $slider_class . ' ' . $slider_class2 . ' layout_id_' . $layout_id . '">';
...
$wtl_template_business_layout = new Wtl_Template_Business_Layout();
