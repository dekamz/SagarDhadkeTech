 ...
 */
class Wtl_Template_Easy_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		$out .= '<div id="wtl_steps" class="wtl_wrapper wp_timeline_post_list schedule_cover layout_id_' . $layout_id . ' ' . $hide_icon_class . ' ' . $slider_class . '">';
		...
		if ( 1 == $layout_type ) {
			...
			jQuery(document).ready(function(){
				...
				var responsive_slider = [
					{breakpoint:767,settings:{slidesToShow:noofslide}},
...
$wtl_template_easy_layout = new Wtl_Template_Easy_Layout();
