 ...
 */
class Wtl_Template_Fullhorizontal_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		$out .= '<div id="wtl_steps" class="wtl_wrapper wp_timeline_post_list full_horizontal fullhorizontal layout_id_' . $layout_id . ' ' . $slider_class . '">';
...
$wtl_template_fullhorizontal_layout = new Wtl_Template_Fullhorizontal_Layout();
