 ...
 */
class Wtl_Template_Infographic_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		$out .= '<div class="wtl_wrapper wp_timeline_post_list schedule_cover layout_id_' . $layout_id . '">';
		$out .= self::heading( $wtl_settings );
		$out .= '<div class="wtl_blog_template blog_template schedule wtl_single_post_wrapp"><div class="wtl-schedule-wrap">';
	 ...
	 * @return html
	 */
	public static function arrow_background_color() {
		global $post;
			...
			if ( isset( $wtl_settings[ 'display_' . $wtl_display_tax_tag ] ) && 1 == $wtl_settings[ 'display_' . $wtl_display_tax_tag ] ) {
				...
				if ( $post_tags ) {
					...
					<div class="wtl-post-tags">
						...
						<span class="tags <?php echo esc_attr( $tags_link ) ? 'wp_timeline_no_links' : 'wp_timeline_has_link'; ?>">
						<?php
...
$wtl_template_infographic_layout = new Wtl_Template_Infographic_Layout();
