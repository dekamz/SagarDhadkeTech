 ...
 */
class Wtl_Template_Milestone_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		$out .= '<div class="wtl_blog_template blog_template schedule wtl_single_post_wrapp">';
		$out .= '<div class="wtl-schedule-wrap column-5">';
		$out .= '<div class="milestone-main-inner">';
...
$wtl_template_milestone_layout = new Wtl_Template_Milestone_Layout();
