 ...
 */
class Wtl_Template_Processinfo_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		$out .= '<div id="wtl_steps" class="wtl_wrapper wp_timeline_post_list processinfo_layout schedule_cover layout_id_' . $layout_id . ' ' . $hide_icon_class . ' ' . $display_timelinebar_class . '">';
...
$Wtl_template_processinfo_layout = new Wtl_Template_Processinfo_Layout();
