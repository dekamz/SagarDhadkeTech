 ...
 */
class Wtl_Template_Rounded_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		if ( 1 == $layout_type ) {
			...
			$noofnavit    = ( isset( $wtl_settings['noof_slide'] ) && '' !== $wtl_settings['noof_slide'] ) ? $wtl_settings['noof_slider_nav_itme'] : 2;
			$noofnavit    = 'rounded_num_item_' . $noofnavit;
		} else {
		...
		$out .= '<div id="wtl_rounded" class="wtl_wrapper ' . $slider_class . ' wp_timeline_post_list schedule_cover layout_id_' . $layout_id . ' ' . $hide_icon_class . '">';
		$out .= self::heading( $wtl_settings );
		$out .= '<div class="wtl-schedule-wrap ' . $noofnavit . '">';
...
$wtl_template_rounded_layout = new Wtl_Template_Rounded_Layout();
