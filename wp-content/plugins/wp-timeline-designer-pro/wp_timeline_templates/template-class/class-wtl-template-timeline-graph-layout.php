 ...
 */
class Wtl_Template_Timeline_Graph_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		$out .= '<div id="wtl_timeline_graph_layout" class="wtl_wrapper wp_timeline_post_list schedule_cover ' . $slider_class . ' ' . $slider_class2 . ' layout_id_' . $layout_id . '">';
		$out .= self::heading( $wtl_settings );
		$out .= '<div class="wtl-schedule-wrap">';
		$out .= '<div class="wtl_blog_template '. $slider_class2 .'">';
...
$wtl_Template_timeline_graph_layout = new Wtl_Template_Timeline_Graph_Layout();
