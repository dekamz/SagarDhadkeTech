 ...
 */
class Wtl_Template_Verticalblur_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		$out .= '<div class="wtl_wrapper wp_timeline_post_list schedule_cover vertical_blur_layout' . $slider_class . ' layout_id_' . $layout_id . ' wtll_style_view_' . $timeline_style_view . ' wtll_style_type_' . $timeline_style_type . '">';
...
$wtl_template_verticalblur_layout = new Wtl_Template_Verticalblur_Layout();
