 ...
 */
class Wtl_Template_ZigZag_Layout {
	/**
	...
	public static function render( $layout_id, $wtl_settings, $template_wrapper ) {
		...
		$out .= '<div class="wtl_wrapper wp_timeline_post_list zigzag_layout schedule_cover layout_id_' . $layout_id . '">';
...
$wtl_template_zigzag_layout = new Wtl_Template_ZigZag_Layout();
